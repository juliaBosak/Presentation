(function (t) {
	...
	0: function (t, e, n) {
		...
		t.exports = n.p + "img/happy_icon.dd54dcba.svg"
	}, "33c9": function (t, e, n) {
		t.exports = n.p + "img/card5.a7b82a78.png"
	}, 5016: function (t, e, n) {
		t.exports = n.p + "img/heart_icon.ec0f5ae5.svg"
	}, "56d7": function (t, e, n) {
		"use strict";
		n.r(e);
				...
				changeCard: function () {
					...
					return new Promise((function (e) {
						setTimeout((function () {
							...
							} else t.currentCardIndex++;
							t.currentCard = t.cardsContent[t.currentCardIndex - 1], t.allowSwipe = !0, e()
						}), 1110)
					}))
		...
		}, v = f, m = Object(u["a"])(v, _, h, !1, null, null, null), C = m.exports, g = function () {
			var t = this, e = t.$createElement, n = t._self._c || e;
			return n("v-touch", {
		...
		}, x = w, P = Object(u["a"])(x, g, b, !1, null, null, null), y = P.exports, I = [d, C, y], S = {
			name: "app", components: {cover: d, mainPage: C, final: y}, data: function () {
		...
		}, O = S, j = (n("fe4c"), Object(u["a"])(O, i, s, !1, null, null, null)), k = j.exports, $ = n("ca95");
		a["a"].use($, {name: "v-touch"}), $.config.swipe = {threshold: 200}, new a["a"]({
			render: function (t) {
				return t(k)
			}
		}).$mount("#app")
		...
		t.exports = n.p + "img/sad_icon.8dbc59a7.svg"
	}, fe4c: function (t, e, n) {
		"use strict";
...
//# sourceMappingURL=app.d3318f3e.js.map